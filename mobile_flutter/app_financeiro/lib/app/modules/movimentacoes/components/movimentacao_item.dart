      ...
      children: <Widget>[
        ...
        ListTile(
          leading: CircleAvatar(
            backgroundColor: item.categoria.tipo == 'TipoCategoria.despesa' ? Colors.red : Colors.green,
          ...
          trailing: Container(
              ...
              child: Text('R\$ ${numberFormat.format(item.valor)}', style: TextStyle(color:  item.categoria.tipo == 'TipoCategoria.despesa' ? Colors.red : Colors.green)),
          ),
        ),
      ]
    );
